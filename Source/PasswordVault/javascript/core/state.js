/* ═══════════════════════════════
   STATE  —  single source of truth for all global variables
   Import order: this file must load before every other src/ file.
═══════════════════════════════ */
...
var _pendingDefaultHandle = null; // held for the resume-banner click
